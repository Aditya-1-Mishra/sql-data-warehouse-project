/*
=========================================================================
Stored Procedure : Laod Silver Layer (Bronze --> Silver)
=========================================================================
Script Purpose :
   This stored Procedure performs ETL ( Extract , Transform , Load ) process to populate the 'silver'
...
begin
	...
	begin try
		...
		trim(cst_firstname) as cst_firstname, -- trim the extra spaces in prfix and suffix of firstname and lastname
		...
		print 'Batch Time to load into silver layer : ' + cast(datediff(second,@batch_start_time,@batch_end_time) as nvarchar);
		print '----- Load Silver is Completed ------'
	end try
